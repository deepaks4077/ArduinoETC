  ...
  void loop() {
      ...
      upOrDown(true,5000);//move forward for 5 seconds and stop
      upOrDown(false,5000);//backward for 5 seconds and stop
      leftOrRight(true,5000);//keep turning right for 5 seconds and stop
      leftOrRight(false,5000);//keep turning left for 5 seconds and stop  
      }
      else{
       brake(tr) 
